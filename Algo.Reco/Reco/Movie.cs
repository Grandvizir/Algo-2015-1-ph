...
namespace Algo
{
    public partial class Movie
    {
        ...
        string _title;
        string[] _categories;
        Dictionary<User, int> _ratingAverage;
        ...
        Movie( string line )
        {
            ...
            _ratingAverage = new Dictionary<User, int>();
        }
        ...
        public void AddRating( User u, int r )
        {
            _ratingAverage.Add( u, r );
        }
        ...
        public Dictionary<User, int> RatingAverage { get { return _ratingAverage; } }
